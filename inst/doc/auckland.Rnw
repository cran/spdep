...
<<label=raw,echo=FALSE,eval=FALSE>>= 
plot(auckpolys, col=cols[findInterval2(res$raw*1000, brks)])
...
<<label=rel,echo=FALSE,eval=FALSE>>= 
plot(auckpolys, col=cols[findInterval2(res$relRisk, brks)])
legend(c(70,90), c(70,95), fill=cols, legend=leglabs(brks), bty="n")
@
...
<<label=pmap,echo=FALSE,eval=FALSE>>= 
plot(auckpolys, col=cols[findInterval2(res$pmap, brks)])
legend(c(70,90), c(70,95), fill=cols, legend=leglabs(brks), bty="n")
@
...
<<label=EBest,echo=FALSE,eval=FALSE>>= 
plot(auckpolys, col=cols[findInterval2(res$estmm*1000, brks)])
legend(c(70,90), c(70,95), fill=cols, legend=leglabs(brks), bty="n")
@
...
<<label=EBloc,echo=FALSE,eval=FALSE>>= 
plot(auckpolys, col=cols[findInterval2(res$est*1000, brks)])
legend(c(70,90), c(70,95), fill=cols, legend=leglabs(brks), bty="n")
@
