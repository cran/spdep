...
\begin{Schunk}
\begin{Sinput}
> plotpolys(auckpolys, auckbbs, col = cols[findInterval2(res$raw * 
+     1000, brks)])
...
\begin{Schunk}
\begin{Sinput}
> plotpolys(auckpolys, auckbbs, col = cols[findInterval2(res$relRisk, 
+     brks)])
> legend(c(70, 90), c(70, 95), fill = cols, legend = leglabs(brks), 
+     bty = "n")
\end{Sinput}
...
\begin{center} 
\begin{Schunk}
\includegraphics{Fig-bitmap-2.png}\end{Schunk}
\end{center}
...
\begin{Schunk}
\begin{Sinput}
> plotpolys(auckpolys, auckbbs, col = cols[findInterval2(res$pmap, 
+     brks)])
> legend(c(70, 90), c(70, 95), fill = cols, legend = leglabs(brks), 
+     bty = "n")
\end{Sinput}
...
\begin{center} 
\begin{Schunk}
\includegraphics{Fig-bitmap-3.png}\end{Schunk}
\end{center}
...
\begin{Schunk}
\begin{Sinput}
> plotpolys(auckpolys, auckbbs, col = cols[findInterval2(res$estmm * 
+     1000, brks)])
> legend(c(70, 90), c(70, 95), fill = cols, legend = leglabs(brks), 
+     bty = "n")
\end{Sinput}
...
\begin{center} 
\begin{Schunk}
\includegraphics{Fig-bitmap-4.png}\end{Schunk}
\end{center}
...
\begin{Schunk}
\begin{Sinput}
> plotpolys(auckpolys, auckbbs, col = cols[findInterval2(res$est * 
+     1000, brks)])
> legend(c(70, 90), c(70, 95), fill = cols, legend = leglabs(brks), 
+     bty = "n")
\end{Sinput}
...
\begin{center} 
\begin{Schunk}
\includegraphics{Fig-bitmap-5.png}\end{Schunk}
\end{center}
